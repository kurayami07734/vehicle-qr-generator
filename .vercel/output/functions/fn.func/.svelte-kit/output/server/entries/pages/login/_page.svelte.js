...
import { c as create_ssr_component, o as onDestroy, a as spread, b as escape_object, d as createEventDispatcher, v as validate_component } from "../../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container"><button>${validate_component(Icon, "Icon").$$render(
    $$result,
    {
      icon: "bi:google",
    ...
    {},
    {}
  )} Continue with Google</button> <button>${validate_component(Icon, "Icon").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} Login with Phone &amp; OTP</button></div>`;
});
export {
  Page as default
};
